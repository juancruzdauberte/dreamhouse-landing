...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Scroll Indicator */}
      <div
        className={`absolute bottom-20 sm:bottom-4 left-1/2 transform-translate-x-1/2 text-white animate-bounce transition-all duration-1000 ease-out delay-1200 ${
