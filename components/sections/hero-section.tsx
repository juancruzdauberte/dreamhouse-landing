...
export function HeroSection() {
  ...
  return (
    <section
      className="relative h-dvh flex items-center justify-center overflow-hidden touch-pan-y"
      id="hero"
    >
      {/* Background Image */}
      ...
      {/* Scroll Indicator */}
      <div
        className={`absolute bottom-16 sm:bottom-4 md:left-1/2 transform-translate-x-1/2 text-white animate-bounce transition-all duration-1000 ease-out delay-1200 ${
